...
public class ClientDataToComImplTest {
    ...
    public void displayUsersListTest() {
        ...
        Assert.assertEquals("CurrentUsers should contain " + nbUser + " users", nbUser, dataClientManager.getCurrentUsers().size());
        Assert.assertTrue("CurrentUsers should contain the user " + specificUser.toString(), dataClientManager.getCurrentUsers().contains(specificUser));
    }
    ...
    public void displayAllGamesTest() {
        ...
        Assert.assertNotNull("dataClientManager shouldn't be null", dataClientManager);
        Assert.assertEquals("CurrentGames should contain " + nbGame + " games", nbGame, dataClientManager.getCurrentGames().size());
        Assert.assertTrue("CurrentGames should contain the game " + specificGame.toString(), dataClientManager.getCurrentGames().contains(specificGame));
    }
}
