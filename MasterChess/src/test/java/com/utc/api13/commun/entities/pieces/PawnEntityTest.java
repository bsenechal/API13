...
public class PawnEntityTest {
    ...
    public void testGenerateAvailableMoves() {
        ...
        //
        // Assert.assertEquals("Error init white Pawn horizontal position",
        // whitePawn.getPosition().getPositionX(),
        // whitePawnPosition.getPositionX());
        // Assert.assertEquals("Error init white Pawn vertical position",
        // whitePawn.getPosition().getPositionY(),
        // whitePawnPosition.getPositionY());
        //
        // Assert.assertEquals("Error init black Pawn horizontal position",
        // blackPawn.getPosition().getPositionX(),
        // blackPawnPosition.getPositionX());
        // Assert.assertEquals("Error init black Pawn vertical position",
        // blackPawn.getPosition().getPositionY(),
        // blackPawnPosition.getPositionY());
        //
        // List<PositionEntity> availablesPositionsWhitePawn =
        // whitePawn.generateAvailableMoves(game);
        // Assert.assertFalse("availablesPositionsWhitePawn should not be
        // empty", availablesPositionsWhitePawn.isEmpty());
        //
        // game.setCurrentPlayer(blackPlayer);
        //
        // // On crée 6 pions supplémentaires pour tester les déplacements
        // PawnEntity blackFriendPawn = new PawnEntity(PieceColorEnum.BLACK, new
        // PositionEntity(5, 6));
        // PawnEntity blackEnemyPawn1 = new PawnEntity(PieceColorEnum.BLACK, new
        // PositionEntity(5, 3));
        // PawnEntity blackEnemyPawn2 = new PawnEntity(PieceColorEnum.BLACK, new
        // PositionEntity(4, 3));
        // PawnEntity blackEnemyPawn3 = new PawnEntity(PieceColorEnum.BLACK, new
        // PositionEntity(6, 3));
        //
        // PawnEntity whiteFriendPawn = new PawnEntity(PieceColorEnum.WHITE, new
        // PositionEntity(5, 3));
        // PawnEntity whiteEnemyPawn1 = new PawnEntity(PieceColorEnum.WHITE, new
        // PositionEntity(5, 6));
        // PawnEntity whiteEnemyPawn2 = new PawnEntity(PieceColorEnum.WHITE, new
        // PositionEntity(4, 6));
        // PawnEntity whiteEnemyPawn3 = new PawnEntity(PieceColorEnum.WHITE, new
        // PositionEntity(6, 6));
        //
        // List<PositionEntity> availablesPositionsBlackPawn =
        // blackPawn.generateAvailableMoves(game);
        // Assert.assertFalse("availablesPositionsBlackPawn should not be
        // empty", availablesPositionsBlackPawn.isEmpty());
        //
        // game.getBlackPieces().add(blackFriendPawn);
        // availablesPositionsBlackPawn =
        // blackPawn.generateAvailableMoves(game);
        // Assert.assertTrue("availablesPositionsBlackPawn should be empty",
        // availablesPositionsBlackPawn.isEmpty());
        ...
        // availablesPositionsWhitePawn =
        // whitePawn.generateAvailableMoves(game);
        // Assert.assertTrue("availablesPositionsWhitePawn should be empty",
        // availablesPositionsWhitePawn.isEmpty());
