...
public class KnightEntityTest {
    ...
    public void generateAvailableMovesTest() {
        ...
        Assert.assertFalse("availablesPositionsWhiteKnight shouldn't be empty", availablesPositionsWhiteKnight.isEmpty());
        Assert.assertEquals("availablesPositionsWhiteKnight should be equal to 2", availablesPositionsWhiteKnight.size(), 2);
        ...
        // Ajout d'un pion de la même couleur pour vérifier que le déplacement n'est plus disponible
        ...
        availablesPositionsWhiteKnight = whiteKnight.generateAvailableMoves(game);
        Assert.assertFalse("availablesPositionsWhiteKnight shouldn't be empty", availablesPositionsWhiteKnight.isEmpty());
        Assert.assertEquals("availablesPositionsWhiteKnight should be equal to 1", availablesPositionsWhiteKnight.size(), 1);
    }
