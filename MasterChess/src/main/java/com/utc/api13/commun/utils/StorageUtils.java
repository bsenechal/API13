...
public class StorageUtils {
     ...
     *             when storage file cannot be created
     */
    public static void write(final PrivateUserEntity user) throws TechnicalException {
        ...
        try {
            ...
            // let's write in the content whether the file existed already or
            // not
     ...
     * 
     * @param fileName
     *            the file name (login + _ + uuid of the user)
     * @return read user
     * @throws TechnicalException
     */
    public static PrivateUserEntity read(final String fileName) throws TechnicalException {
        try {
            ...
            throw new DataAccessException(
                    "The class " + icx.classname + " has changed since the serialization of object", icx);
        } catch (StreamCorruptedException scx) {
            throw new DataAccessException(
                    "The file " + PATH + File.separator + fileName + " is corrupted. Do not modify storage files!",
                    scx);
