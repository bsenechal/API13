...
/**
 * 
 * @author stephane, clemence This class allow message transmission through
 *         Netty It establishes the connection on the given port number. When
 *         the connection is ready you can use the method sendMessage Don't
...
public class ComClientManager {
    ...
    /**
     * @param clientComToDataImpl
     *            the clientToDataImpl to set
     */
