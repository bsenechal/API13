...
public class AnswerPropositionController {
    ...
    public void onYesClicked() {
        ...
        try {
            this.myIClientToIHM.sendResponse(answeringUser/* , enquirerUUID */, answer, observable,
                    chattable/* , timer, timeInt */);
    ...
    public void setBindings(PropositionProperty proposition) {
         ...
         * 
         * userInfoWon.setCellValueFactory(new
         * PropertyValueFactory<PrivateUserEntity, Integer>("nbWon"));
         * userInfoLost.setCellValueFactory(new
         * PropertyValueFactory<PrivateUserEntity, Integer>("nbLost"));
         * userInfoPlayed.setCellValueFactory(new
         * PropertyValueFactory<PrivateUserEntity, Integer>("nbPlayed"));
         * 
         * profile.statPlayerProperty().addListener((ListChangeListener.Change<?
         * extends PublicUserEntity> el) -> {
