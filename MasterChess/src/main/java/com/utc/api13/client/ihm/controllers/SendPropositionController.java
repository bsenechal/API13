...
public class SendPropositionController {
    ...
    private void setListenersOnLoad() {
        this.sendPropositionButton.setOnAction(evt -> { // ou quand proposition
                                                        // change ?? pour que ça
                                                        // soit apres
            Stage stage;
            Parent root = null;
            ...
            try {
                ...
                controller.setMainApp(mainApp, this.proposition.loginAskingPayerProperty().toString(),
                        Boolean.valueOf(this.proposition.chattableProperty().toString()),
                        Boolean.valueOf(this.proposition.timerProperty().toString()),
                        Boolean.valueOf(this.proposition.observableProperty().toString()),
                        Integer.parseInt(this.proposition.timeProperty().toString()));
                stage.setScene(new Scene(root));
